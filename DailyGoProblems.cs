...
namespace UnitTestProject
{
 ...
 18 . . . O . . . . . . . . . . . . . . .
        ...
        public void DailyGoProblems_20250311_8()
        {
            ...
            Assert.AreEqual(RedundantMoveHelper.RedundantFillerMove(tryMove2), true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . .
        ...
        public void DailyGoProblems_20250326_8()
        {
            ...
            GameTryMove move = new GameTryMove(g, new Point(7, 14));
 ...
 18 . . . . . . . . . . . . . . . . . . .
        ...
        public void DailyGoProblems_20250714_8()
        {
            ...
            Assert.AreEqual(tryMove.IsLeapMove, true);
        }
 ...
 18 . . . . . . O O . . . . . . . . . . .
        ...
        public void DailyGoProblems_20250920_6()
        {
            ...
            g.GameInfo.targetPoints.Add(new Point(5, 17));
 ...
 18 . . . . . . . . . . . . . . . . . . .
         */
        [TestMethod]
        public void DailyGoProblems_20251210_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.Black);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(0, 6));
            gi.killMovablePoints.Add(new Point(4, 8));
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(0, 9))) != null, true);
        }
 ...
 15 X O O O X O . O . . X . . . . . . . . 
 16 . X X O X O . . O X . . . . . . . . . 
 17 X X O O O . O X O X . . . . . . . . . 
 18 . . X . X . O O X X . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260103_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(8, 13));
            g.MakeMove(7, 17);
            g.MakeMove(7, 18);
            g.MakeMove(4, 18);
            g.MakeMove(3, 17);
 ...
 18 . . . . X . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260111_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
            ...
            Assert.AreEqual(RedundantMoveHelper.RedundantKillLeapMove(new GameTryMove(g, new Point(1, 18))), false);
 ...
 18 . X X . O . O X . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260112_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 18 X X X . X . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260113_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 18 . O . . . . . O . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260114_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260123_7()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            ...
            g.SetupMove(4, 14, Content.Black);
            g.SetupMove(4, 16, Content.Black);
            g.GameInfo.targetPoints.Add(new Point(1, 12));
            for (int x = 0; x <= 3; x++)
            {
                for (int y = 11; y <= 15; y++)
                    gi.movablePoints.Add(new Point(x, y));
 ...
 18 . . X . . X . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260127_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.Add(new Point(8, 18));
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(5, 14))) != null, true);
        }
 ...
 18 . X X X X . X . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260206_6()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 15 . . O X X O X X O O . . . . . . . . . 
 16 . . O X . X O X X O . . . . . . . . . 
 17 . . O X X O O X X O . O . . . . . . . 
 18 . . . . . . . X O . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260318_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.SurviveWithKo, Content.Black);
            Game g = new Game(gi);
 ...
 18 . X . . O X . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260319_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
 ...
 18 . . O X X . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260321_3()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 18 . X O . . . O . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260322_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 18 O . O X X . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260329_6()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 18 O . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260330_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 14 . . O X X X . X . . O . . . . . . . . 
 15 . O . X O X X X X X . . . . . . . . . 
 16 . O . X O X O O O X O O O O . . . . . 
 17 . O . X O O . . . O X . . . . . . . . 
 18 . . . X X . O . . O . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260401_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.Black);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.Add(new Point(10, 16));
            gi.killMovablePoints.Add(new Point(11, 15));
            gi.killMovablePoints.Add(new Point(11, 17));
            gi.killMovablePoints.Add(new Point(11, 18));
            g.MakeMove(4, 18);
            g.MakeMove(6, 18);
            g.MakeMove(3, 18);
            g.MakeMove(10, 16);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(8, 18))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(8, 18))) != null, true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260403_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            ...
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantFillerMove(new GameTryMove(g, new Point(1, 17))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(1, 17))) != null, true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260406_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.Black);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(4, 18));
            gi.survivalLinkPoints.Add(new Point(1, 11));
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            ConfirmAliveResult moveResult = g.InitializeComputerMove();
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260418_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
 ...
 18 . O O . . . X O O . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260512_7()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.SurviveWithKo, Content.Black);
            Game g = new Game(gi);
            ...
            g.MakeMove(4, 16);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantTigerMouthMove(new GameTryMove(g, new Point(5, 18))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(5, 18))) != null, true);
        }
 ...
 18 . . . X . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260515_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.Add(new Point(0, 10));
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantNonSuicidalMove(new GameTryMove(g, new Point(1, 16))), false);
 ...
 13 . . . . . X X X O . . . . . . . . . . 
 14 . . . O O O . X . . . . . . . . . . . 
 15 . X X O X X X X O O . X . . X . X . . 
 16 . O O X O X X O . . . . . . . O X . . 
 17 . X X X O O X O . . O . . . . . . . . 
 18 . . . . . O O . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260516_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.Black);
            Game g = new Game(gi);
            ...
            g.SetupMove(9, 15, Content.White);
            g.SetupMove(11, 15, Content.Black);
            g.SetupMove(14, 15, Content.Black);
            g.SetupMove(15, 16, Content.White);
            g.SetupMove(16, 15, Content.Black);
            g.SetupMove(16, 16, Content.Black);
            g.GameInfo.targetPoints.Add(new Point(6, 15));
            for (int x = 0; x <= 13; x++)
            {
                for (int y = 8; y <= 18; y++)
                    gi.movablePoints.Add(new Point(x, y));
            ...
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(8, 16))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(8, 16))) != null, true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260521_7()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.White);
            Game g = new Game(gi);
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260522_4()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.Black);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.Add(new Point(0, 9));
            gi.killMovablePoints.Add(new Point(1, 10));
            gi.movablePoints.Add(new Point(6, 12));
            gi.movablePoints.Add(new Point(7, 13));
            gi.movablePoints.Add(new Point(6, 15));
            g.GameInfo.survivalPoints.Add(new Point(5, 15));
            g.MakeMove(1, 15);
            g.MakeMove(0, 13);
            Assert.AreEqual(GameHelper.GetTryMovesForGame(g).FirstOrDefault(t => t.Move.Equals(new Point(1, 11))) != null, true);
            g.MakeMove(1, 11);
            g.MakeMove(0, 12);
 ...
 18 . . X X . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260528_7()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.White);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(0, 8));
            gi.killMovablePoints.Add(new Point(4, 10));
            gi.killMovablePoints.Add(new Point(4, 11));
            gi.killMovablePoints.Add(new Point(4, 12));
            gi.killMovablePoints.Add(new Point(5, 13));
            gi.killMovablePoints.Add(new Point(5, 18));
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantSurvivalLeapMove(new GameTryMove(g, new Point(1, 14))), false);
 ...
 18 . X . X X O O . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260601_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(1, 13, Content.Black);
 ...
 18 . X X . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260614_4()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 18 . X . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260624_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 18 . . . O . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260625_7()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.SurviveWithKo, Content.Black);
            Game g = new Game(gi);
            ...
            gi.killMovablePoints.Add(new Point(6, 18));
            gi.movablePoints.Add(new Point(0, 12));
            gi.survivalPoints.Add(new Point(0, 13));
            Assert.AreEqual(GameHelper.GetTryMovesForGame(g).FirstOrDefault(t => t.Move.Equals(new Point(1, 18))) != null, true);
            g.MakeMove(1, 18);
            g.MakeMove(2, 18);
            Assert.AreEqual(GameHelper.GetTryMovesForGame(g).FirstOrDefault(t => t.Move.Equals(new Point(0, 17))) != null, true);
            ConfirmAliveResult moveResult = g.InitializeComputerMove();
            Point move = g.Board.LastMove.Value;
            Assert.AreEqual(moveResult.HasFlag(ConfirmAliveResult.Alive), true);
        }
 ...
 18 . O O O X O O . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260705_3()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.Black);
            Game g = new Game(gi);
 ...
 18 O . O . O X . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260711_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
            ...
            Game game = SearchAnswer(g);
            Point move = game.Board.LastMove.Value;
            Assert.AreEqual(move.Equals(new Point(1, 18)) || move.Equals(new Point(3, 18)), true);
        }
 ...
 18 . . . . . . . . X X . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260723_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
            ...
            g.SetupMove(9, 17, Content.Black);
            g.SetupMove(9, 18, Content.Black);
            g.GameInfo.targetPoints.Add(new Point(7, 14));
            for (int x = 3; x <= 8; x++)
            {
                for (int y = 14; y <= 18; y++)
                    gi.movablePoints.Add(new Point(x, y));
            ...
            gi.movablePoints.Add(new Point(2, 18));
            gi.killMovablePoints.Add(new Point(5, 13));
            gi.killMovablePoints.Add(new Point(7, 13));
            gi.survivalLinkPoints.Add(new Point(2, 16));
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260724_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260725_7()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.White);
            Game g = new Game(gi);
            ...
            g.SetupMove(10, 15, Content.Black);
            g.SetupMove(10, 17, Content.Black);
            g.GameInfo.targetPoints.Add(new Point(7, 16));
            for (int x = 3; x <= 8; x++)
            {
                for (int y = 15; y <= 18; y++)
                    gi.movablePoints.Add(new Point(x, y));
            ...
            gi.movablePoints.Add(new Point(2, 17));
            gi.movablePoints.Add(new Point(1, 18));
            gi.movablePoints.Add(new Point(9, 16));
            gi.movablePoints.Add(new Point(9, 17));
            gi.movablePoints.Add(new Point(10, 18));
            gi.survivalPoints.Add(new Point(4, 16));
            gi.survivalLinkPoints.Add(new Point(2, 15));
            g.MakeMove(6, 16);
            g.MakeMove(6, 17);
            g.MakeMove(5, 17);
            g.MakeMove(5, 16);
 ...
 18 . . . X X . . . . O . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_2026725_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            ...
            g.MakeMove(7, 16);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.NeutralPointKillMove(new GameTryMove(g, new Point(6, 17))), false);
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260726_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            ...
            Assert.AreEqual(GameHelper.GetTryMovesForGame(g).FirstOrDefault(t => t.Move.Equals(new Point(1, 15))) != null, true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        ...
        public void DailyGoProblems_20260727_8()
        {
            ...
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(6, 13))), true);
            if (!PerformanceBenchmarkTest.includeLongRunningTests) return;
            g.MakeMove(5, 17);
            g.MakeMove(3, 18);
            g.MakeMove(3, 15);
        ...
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.Black, 13);
            Game g = new Game(gi);
            g.SetupMove(1, 12, Content.White);
            g.SetupMove(1, 13, Content.Black);
            g.SetupMove(1, 14, Content.White);
 ...
 18 . . O . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260802_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260803_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            ...
            g.MakeMove(1, 14);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantTigerMouthMove(new GameTryMove(g, new Point(0, 16))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(0, 16))) != null, true);
        }
 ...
 12 . X O . X . . . . . . . . . . . . . . 
 13 X . O . . . . . . . . . . . . . . . . 
 14 . O . X X X X X X X O . . . . . . . . 
 15 O O X . X O O O O O X . . . . . . . . 
 16 . X O . O O O X X X . . X . . . . . . 
 17 . X O . . O X X . . . . . . . . . . . 
 18 . X . . . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260804_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Survive, Content.White, 15);
            gi.SurvivalWinForBothAlive = false;
            Game g = new Game(gi);
            g.SetupMove(0, 10, Content.White);
            g.SetupMove(0, 11, Content.Black);
            g.SetupMove(0, 13, Content.Black);
            ...
            gi.movablePoints.Add(new Point(11, 15));
            gi.movablePoints.Add(new Point(11, 18));
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(11, 16));
            gi.killMovablePoints.Add(new Point(11, 17));
 ...
 18 O . O . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_2026807_7()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.SurviveWithKo, Content.Black);
            Game g = new Game(gi);
 ...
 18 . . . . X . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_2026809_6()
        {
            Scenario s = new Scenario();
        ...
        /*
 14 . . . . . . . O O O O . . . . . . . . 
 15 . . O O O O O X X O X O . . . . . . . 
 16 . . . . . . . X . X . O . . . . . . . 
 17 . . O O X . X . O X . O . . . . . . . 
 18 . . . . X . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260809_8()
        {
            Scenario s = new Scenario();
            ...
            g.SetupMove(11, 16, Content.White);
            g.SetupMove(11, 17, Content.White);
            g.GameInfo.targetPoints.Add(new Point(9, 17));
            for (int x = 4; x <= 11; x++)
            {
                for (int y = 15; y <= 18; y++)
                    gi.movablePoints.Add(new Point(x, y));
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260810_8()
        {
            Scenario s = new Scenario();
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260812_8()
        {
            Scenario s = new Scenario();
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260814_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black, 19);
            Game g = new Game(gi);
            g.SetupMove(1, 15, Content.Black);
            ...
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(0, 12));
            gi.killMovablePoints.Add(new Point(1, 13));
            gi.killMovablePoints.Add(new Point(6, 12));
            gi.killMovablePoints.Add(new Point(7, 18));
            gi.survivalPoints.Add(new Point(1, 16));
            g.MakeMove(4, 16);
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260815_6()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(0, 16, Content.Black);
            ...
            gi.survivalPoints.Add(new Point(0, 16));
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(0, 15))) != null, true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260815_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(0, 11, Content.Black);
            ...
            g.MakeMove(0, 12);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.NeutralPointSurvivalMove(new GameTryMove(g, new Point(0, 17))), true);
        }
 ...
 18 . . . . . . . . . X . . . . . . . . .
        */
        ...
        public void DailyGoProblems_20260816_6()
        {
            ...
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(1, 18));
            gi.killMovablePoints.Add(new Point(8, 16));
            gi.survivalLinkPoints.Add(new Point(12, 17));
            gi.movablePoints.Add(new Point(13, 18));
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.NeutralPointKillMove(new GameTryMove(g, new Point(10, 18))), false);
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260816_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black, 23);
            Game g = new Game(gi);
            g.SetupMove(1, 17, Content.Black);
            g.SetupMove(2, 15, Content.Black);
            g.SetupMove(2, 16, Content.Black);
            ...
            g.SetupMove(11, 17, Content.Black);
            g.GameInfo.targetPoints.Add(new Point(6, 16));
            g.GameInfo.targetPoints.Add(new Point(9, 16));
            for (int x = 4; x <= 9; x++)
            {
                for (int y = 16; y <= 18; y++)
                    gi.movablePoints.Add(new Point(x, y));
 ...
 18 . . . X . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260817_7()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(0, 12, Content.Black);
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260818_7()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(1, 14, Content.Black);
            ...
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(2, 17));
            gi.killMovablePoints.Add(new Point(3, 17));
            gi.killMovablePoints.Add(new Point(4, 17));
            gi.killMovablePoints.Add(new Point(7, 17));
            g.MakeMove(6, 16);
            g.MakeMove(6, 15);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(4, 14))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(4, 14))) != null, true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        ...
        */
        [TestMethod]
        public void DailyGoProblems_20260820_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(0, 14, Content.White);
            ...
            g.MakeMove(0, 17);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(0, 16))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(0, 16))) != null, true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260821_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(1, 13, Content.Black);
 ...
 18 . O . O . X . O . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260822_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(0, 17, Content.Black);
 ...
 18 . O . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260826_7()
        {
 ...
 18 . X . O X X . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260826_8()
        {
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(0, 13, Content.White);
            ...
            g.MakeMove(2, 16);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantTigerMouthMove(new GameTryMove(g, new Point(1, 16))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(1, 16))) != null, true);
        }
 ...
 13 . . . . . . . . . X . . . . . . . . . 
 14 . . X . . O . O O O X X . . . . . . . 
 15 . . . . O . . O X X O X O O O . O . . 
 16 . X . O . . . . X X O O X X . O . . . 
 17 . . . . . . . . X O O . . . . . . . . 
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260827_7()
        {
            var gi = new GameInfo(SurviveOrKill.SurviveWithKo, Content.Black, 17);
            Game g = new Game(gi);
            g.SetupMove(1, 16, Content.Black);
            g.SetupMove(2, 14, Content.Black);
            g.SetupMove(3, 12, Content.Black);
            ...
            g.SetupMove(13, 15, Content.White);
            g.SetupMove(13, 16, Content.Black);
            g.SetupMove(14, 15, Content.White);
            g.SetupMove(15, 16, Content.White);
            g.SetupMove(16, 15, Content.White);
            g.GameInfo.targetPoints.Add(new Point(12, 16));
            for (int x = 7; x <= 14; x++)
            {
                for (int y = 16; y <= 18; y++)
                    gi.movablePoints.Add(new Point(x, y));
            ...
            gi.killMovablePoints.Add(new Point(6, 16));
            gi.killMovablePoints.Add(new Point(5, 17));
            gi.killMovablePoints.Add(new Point(15, 17));
            gi.killMovablePoints.Add(new Point(16, 18));
            gi.survivalPoints.Add(new Point(9, 15));
            gi.survivalPoints.Add(new Point(10, 15));
            g.MakeMove(9, 16);
            g.MakeMove(9, 17);
            g.MakeMove(8, 17);
            ...
            g.MakeMove(10, 17);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(10, 18))), true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260827_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(1, 10, Content.Black);
 ...
 18 . . . . . . O . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260901_8()
        {
            var gi = new GameInfo(SurviveOrKill.SurviveWithKo, Content.White);
            Game g = new Game(gi);
            g.SetupMove(0, 13, Content.Black);
 ...
 18 . . . . . . O . . . . . . . . . . . . 
        */
        ...
        public void DailyGoProblems_20260903_8()
        {
            ...
            Assert.AreEqual(RedundantMoveHelper.RedundantTigerMouthMove(new GameTryMove(g, new Point(5, 18))), true);
        }
 ...
 18 . . . . . O . X . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260904_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(1, 12, Content.Black);
 ...
 18 . O X O . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260905_8()
        {
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(0, 13, Content.Black);
 ...
 18 . . . . . X . . . . . . . . . . . . . 
        */
        ...
        public static Game Scenario_20260908_8()
        {
            ...
            g.SetupMove(6, 16, Content.White);
            g.SetupMove(6, 17, Content.Black);
            g.SetupMove(7, 9, Content.White);
            g.SetupMove(7, 10, Content.Black);
            g.SetupMove(7, 11, Content.Black);
            g.SetupMove(7, 12, Content.White);
            g.SetupMove(7, 14, Content.White);
            g.SetupMove(7, 16, Content.Black);
 ...
 18 . X . O O X . X . . . . . . . . . . .
         */
        [TestMethod]
        public void DailyGoProblems_20260914_8()
        {
            Game g = Scenario_20260914_8();
            g.MakeMove(3, 17);
            g.MakeMove(2, 17);
            g.MakeMove(1, 18);
            g.MakeMove(1, 17);
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260917_8()
        {
            var gi = new GameInfo(SurviveOrKill.SurviveWithKo, Content.White);
            Game g = new Game(gi);
            g.SetupMove(1, 16, Content.Black);
 ...
 18 . . X O . . . . O X . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260918_8()
        {
            Game g = Scenario_20260918_8();
            g.MakeMove(4, 16);
            g.MakeMove(5, 16);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.NeutralPointKillMove(new GameTryMove(g, new Point(5, 15))), false);
 ...
 18 . . X O . . . . O X . . . . . . . . .
        */
        public static Game Scenario_20260918_8()
        {
            var gi = new GameInfo(SurviveOrKill.Kill, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(2, 15, Content.Black);
 ...
 18 . . X O . . . . . . . . . . . . . . .
        */
        [TestMethod]
        public void DailyGoProblems_20260921_6()
        {
            var gi = new GameInfo(SurviveOrKill.SurviveWithKo, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(1, 13, Content.White);
            ...
            g.MakeMove(0, 18);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.NeutralPointSurvivalMove(new GameTryMove(g, new Point(4, 18))), true);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(4, 18))) != null, true);
        }
...
18 . . . . . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void DailyGoProblems_20260921_7()
        {
            var gi = new GameInfo(SurviveOrKill.Survive, Content.Black);
            Game g = new Game(gi);
            g.SetupMove(2, 16, Content.White);
            ...
            gi.killMovablePoints.Add(new Point(11, 18));
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantNonSuicidalMove(new GameTryMove(g, new Point(8, 16))), false);
        }
        /*
8 . . X . X . . . . . . . . . . . . . . 
9 . X X . X . . . . . . . . . . . . . . 
...
*/
        [TestMethod]
        public void DailyGoProblems_20260923_8()
        {
            Game g = Scenario_20260923_8();
            Assert.AreEqual(RedundantMoveHelper.RedundantTigerMouthMove(new GameTryMove(g, new Point(2, 11))), true);
            Assert.AreEqual(RedundantMoveHelper.RedundantKillLeapMove(new GameTryMove(g, new Point(0, 17))), true);
        }

        public static Game Scenario_20260923_8()
        {
            var gi = new GameInfo(SurviveOrKill.KillWithKo, Content.Black, 15);
            Game g = new Game(gi);
            g.SetupMove(0, 16, Content.Black);
            g.SetupMove(1, 9, Content.Black);
            g.SetupMove(1, 10, Content.Black);
            ...
            gi.movablePoints.Add(new Point(5, 11));
            gi.killMovablePoints.AddRange(gi.movablePoints);
            gi.killMovablePoints.Add(new Point(0, 9));
            gi.killMovablePoints.Add(new Point(3, 9));
            gi.killMovablePoints.Add(new Point(4, 18));
