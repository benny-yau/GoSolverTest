...
namespace UnitTestProject
{
 ...
 18 . . . . O X X X . . . . . . . . . . . 
        ...
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q17132_2()
        {
            ...
            GameTryMove move = new GameTryMove(g, new Point(8, 18));
            Boolean isSuicidal = RedundantMoveHelper.SuicidalRedundantMove(move);
            Assert.AreEqual(isSuicidal, true);

            g.MakeMove(9, 18);
            g.MakeMove(-1, -1);
            GameTryMove move2 = new GameTryMove(g, new Point(8, 18));
 ...
 18 . X . X X O O . X . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q17250_2()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_TianLongTu_Q17250();
            g.MakeMove(4, 15);
 ...
 18 . O X O . X . . . . . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario6kyu13_2()
        {
            Scenario s = new Scenario();
 ...
 18 . . . . . . . . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_XuanXuanGo_A41()
        {
            Scenario s = new Scenario();
 ...
 18 . X O . . . . . . . . . . . . . . . .
       */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_XuanXuanGo_A53_101Weiqi_2()
        {
            Scenario s = new Scenario();
 ...
 18 . O . X . O . . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q14992()
        {
            Scenario s = new Scenario();
            ...
            g.MakeMove(0, 17);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(2, 18))), false);
        }
 ...
 18 . O . X . O . . . . . . . . . . . . .
        */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q14992_2()
        {
            Scenario s = new Scenario();
 ...
 14 O O X X X O . O . . . . . . . . . . . 
 15 . O O X X O O O . . . . . . . . . . . 
 16 O X X X X O X X O . . . . . . . . . . 
 17 . O O X X O X O O . . . . . . . . . . 
 18 O . X . X . X . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_20260727_8()
        {
 ...
 18 . . . . . . . . . . . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_XuanXuanQiJing_Weiqi101_A40()
        {
            Scenario s = new Scenario();
 ...
 18 . O . X O . . . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_Corner_A113_5()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_Corner_A113();
            g.MakeMove(1, 17);
