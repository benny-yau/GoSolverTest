...
namespace UnitTestProject
{
 ...
 18 . . O . . . O X X . . . . . . . . . . 
        */
        ...
        public void SuicidalRedundantMoveTest_Scenario_WuQingYuan_Q5971()
        {
            ...
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantTigerMouthMove(new GameTryMove(g, new Point(3, 18))), true);
 ...
 18 . . X . X . . . . . . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_Corner_A79()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_Corner_A79();
            g.MakeMove(1, 17);
            g.MakeMove(0, 16);
            g.MakeMove(2, 17);
            g.MakeMove(2, 18);
 ...
 18 . . . . . O O . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_20260727_8_2()
        {
 ...
 18 . O . . . X X . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_Nie4_5()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_Nie4();
            g.MakeMove(0, 17);
 ...
 18 . . X O . . . . . X . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_WuQingYuan_Q31510_3()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_WuQingYuan_Q31510();
            g.MakeMove(4, 16);
 ...
 18 . . . X O . X . O X X . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_WuQingYuan_Q31444_2()
        {
            Scenario s = new Scenario();
 ...
 18 . O . . . . . . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_20260813_8()
        {
            Game g = DailyGoProblems.Scenario_20260813_8();
            g.MakeMove(0, 15);
            g.MakeMove(1, 18);
            g.MakeMove(2, 17);
            g.MakeMove(1, 17);
 ...
 18 . . . . O X . O X . . . . . . . . . .
        */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_WuQingYuan_Q31305()
        {
            Scenario s = new Scenario();
 ...
 18 . . O X . . . X . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_Side_B37()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_Side_B37();
            g.MakeMove(7, 18);
            g.MakeMove(4, 17);
            g.MakeMove(3, 15);
            g.MakeMove(2, 18);
 ...
 18 . . . . . X . . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_20260908_8()
        {
            Game g = DailyGoProblems.Scenario_20260908_8();
            g.MakeMove(1, 17);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
 ...
 18 . . . O . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void SuicidalRedundantMoveTest_20260902_8_2()
        {
            Game g = DailyGoProblems.Scenario_20260902_8();
            g.MakeMove(6, 17);
            g.MakeMove(5, 17);
 ...
 18 . . X X O O X . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_Nie109()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_Nie109();
            g.MakeMove(2, 17);
            g.MakeMove(2, 16);
            g.MakeMove(3, 18);
            g.MakeMove(4, 18);
            ...
            g.MakeMove(3, 16);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(1, 17))), false);
            Assert.AreEqual(tryMoves.FirstOrDefault(t => t.Move.Equals(new Point(1, 17))) != null, true);
        }
 ...
 18 . . . . . . . . . . . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_WindAndTime_Q30005()
        {
            Scenario s = new Scenario();
 ...
 18 . . . X . . . . O X . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q16490_3()
        {
            Scenario s = new Scenario();
 ...
 18 . . . . . . . . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_GuanZiPu_B3Q63_101Weiqi()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_GuanZiPu_B3Q63_101Weiqi();
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(1, 17))), true);
        }
 ...
 18 . . . . . . . . . O . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q16735()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_TianLongTu_Q16735();
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(4, 17))), true);
        }
 ...
 18 . . X X X O . X . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q15618_2()
        {
            Scenario s = new Scenario();
 ...
 18 . . . . . . . . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_WindAndTime_Q30241_2()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_WindAndTime_Q30241();
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
 ...
 18 . . . X . . . . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q17132_6()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_TianLongTu_Q17132();
            g.MakeMove(3, 18);
 ...
 18 . . . . . . . . O X . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q16490_4()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_TianLongTu_Q16490();
            g.MakeMove(4, 17);
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        */
        [TestMethod]
        public void SuicidalRedundantMoveTest_20260923_8()
        {
            Game g = DailyGoProblems.Scenario_20260923_8();
            g.MakeMove(0, 11);
            g.MakeMove(0, 12);
            g.MakeMove(1, 13);
            g.MakeMove(2, 14);
            ...
            g.MakeMove(2, 13);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(0, 13))), false);
