...
namespace UnitTestProject
{
 ...
 18 X O O . O . . . . . . . . . . . . . . 
        ...
        public void FillKoEyeMoveTest_Scenario_Corner_A85()
        {
            ...
            Boolean fillKoEye = RedundantMoveHelper.FillKoEyeMove(tryMove);
            Assert.AreEqual(fillKoEye, true);
 ...
 18 O . X X X O X . . . . . . . . . . . .
        ...
        public void FillKoEyeMoveTest_Scenario_WindAndTime_Q30275_2()
        {
            ...
            GameTryMove tryMove2 = new GameTryMove(g, new Point(5, 16));
            Boolean isRedundant2 = RedundantMoveHelper.RedundantKoMove(tryMove2);
 ...
 18 O . X X X O X . . . . . . . . . . . .
        ...
        public void FillKoEyeMoveTest_Scenario_WindAndTime_Q30275_3()
        {
            ...
            g.GameInfo.movablePoints.Add(new Point(1, 15));
            g.GameInfo.movablePoints.Add(new Point(4, 13));
            g.GameInfo.movablePoints.Add(new Point(5, 12));
            g.GameInfo.movablePoints.Add(new Point(6, 13));
            ...
            g.MakeMove(3, 3);
            GameTryMove tryMove2 = new GameTryMove(g, new Point(5, 15));
 ...
 18 . X . X . . X . . . . . . . . . . . . 
       */
        [TestMethod]
        public void FillKoEyeMoveTest_Scenario_GuanZiPu_Q14906()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_GuanZiPu_Q14906();
            g.MakeMove(1, 18);
            g.MakeMove(0, 17);
            g.MakeMove(3, 18);
            g.MakeMove(4, 18);
            ...
            g.MakeMove(3, 17);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.FillKoEyeMove(new GameTryMove(g, new Point(2, 18))), false);
 ...
 18 . O X . X . . . . . . . . . . . . . .
         */
        [TestMethod]
        public void FillKoEyeMoveTest_Scenario_GuanZiPu_A2Q28_101Weiqi()
        {
            Scenario s = new Scenario();
            ...
            g.MakeMove(3, 15);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.FillKoEyeMove(new GameTryMove(g, new Point(3, 18))), false);
