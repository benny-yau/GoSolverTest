...
namespace UnitTestProject
{
 ...
 18 . . O O X X X O X . . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_XuanXuanQiJing_Weiqi101_2282z()
        {
            Scenario s = new Scenario();
 ...
 18 . X O . . . . . . . . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_XuanXuanGo_A37_101Weiqi()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_XuanXuanGo_A37_101Weiqi();
            g.MakeMove(2, 14);
            g.MakeMove(1, 14);
            g.MakeMove(0, 16);
            g.MakeMove(1, 18);
            ...
            g.MakeMove(0, 15);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(1, 16))), false);
 ...
 18 . . . . . X O . . . . . . . . . . . . 
         ...
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_WindAndTime_Q29366()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_WindAndTime_Q29366();
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
 ...
 18 . X O . . . . . . . . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario1dan29()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario1dan29();
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
 ...
 18 . . . . . . . . . X . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_TianLongTu_Q2174_2()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_TianLongTu_Q2174();
            g.MakeMove(9, 18);
 ...
 18 . . . X O . . O X . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_WuQingYuan_Q31305_2()
        {
            Scenario s = new Scenario();
 ...
 18 O O X . . . . . . . . . . . . . . . . 
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_XuanXuanGo_A28_101Weiqi_3()
        {
            Scenario s = new Scenario();
            ...
            g.MakeMove(0, 18);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.SuicidalRedundantMove(new GameTryMove(g, new Point(2, 15))), false);
 ...
 18 . . . X X . O . . . . . . . . . . . .
         */
        [TestMethod]
        public void SuicidalRedundantMoveTest_Scenario_XuanXuanGo_B7()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_XuanXuanGo_B7();
            g.MakeMove(3, 18);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
