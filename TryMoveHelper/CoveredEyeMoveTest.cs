...
namespace UnitTestProject
{
 ...
 18 . O X X . . . . . . . . . . . . . . . 
        ...
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_XuanXuanQiJing_A11();
            g.MakeMove(0, 16);
            g.MakeMove(0, 17);
            g.MakeMove(1, 18);
            g.MakeMove(2, 18);
 ...
 18 . . . . . . . . . . . . . . . . . . . 
        ...
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_XuanXuanQiJing_A52();
            g.MakeMove(5, 15);
            g.MakeMove(4, 14);
            g.MakeMove(4, 12);
            g.MakeMove(4, 13);
            ...
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            GameTryMove tryMove = new GameTryMove(g, new Point(5, 13));
            Boolean coveredEyeMove = RedundantMoveHelper.RedundantCoveredEyeMove(tryMove);
            Assert.AreEqual(coveredEyeMove, false);
 ...
 18 . . X . X . X O O . . . . . . . . . .
        ...
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_GuanZiPu_Q19336();
            g.MakeMove(3, 18);
            g.MakeMove(4, 18);
            g.MakeMove(3, 16);
            g.MakeMove(2, 18);
 ...
 18 . X O O O O O . . . . . . . . . . . . 
       */
        [TestMethod]
        public void CoveredEyeMoveTest_Scenario_XuanXuanGo_Q18341_3()
        {
            Scenario s = new Scenario();
            Game g = s.Scenario_XuanXuanGo_Q18341();
            g.MakeMove(1, 16);
            ...
            g.MakeMove(4, 15);
            List<GameTryMove> tryMoves = GameHelper.GetTryMovesForGame(g);
            Assert.AreEqual(RedundantMoveHelper.RedundantCoveredEyeMove(new GameTryMove(g, new Point(0, 18))), false);
        }
    }
}
